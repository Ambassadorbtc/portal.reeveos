        ...
        <div style={desk?{display:'flex',gap:40,alignItems:'flex-start'}:{}}>
          ...
          <div style={{width:desk?440:'100%',flexShrink:0}}>
            <div style={{background:$.card,borderRadius:12,border:`1px solid ${$.bdr}`,padding:desk?24:20,boxShadow:'0 8px 32px rgba(0,0,0,0.05)'}}>
              ...
              <button onClick={doAuth} disabled={loading} style={{width:'100%',padding:desk?'9px 0':'14px 0',borderRadius:desk?8:12,border:'none',background:$.acc,color:'#fff',fontSize:desk?13:16,fontWeight:700,cursor:loading?'wait':'pointer',fontFamily:$.f,opacity:loading?0.6:1,textTransform:'uppercase',marginBottom:14}}>{loading?'Please wait...':authMode==='login'?'Log In':'Create Account'}</button>
