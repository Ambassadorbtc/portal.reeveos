...
const PickGuestsDate = ({ data, onContinue }) => {
  ...
  return (
    <div className="px-4 pt-3 overflow-hidden">
      ...
      {/* Guest count */}
      <h2 className="text-sm font-semibold text-[#111111] mb-2">How many guests?</h2>
      ...
      {/* Calendar */}
      <h2 className="text-sm font-semibold text-[#111111] mb-2">Pick a date</h2>
      ...
      {/* Selection summary */}
      {selectedDate && (
        <div className="flex items-center gap-2.5 p-2.5 bg-[#111111]/[0.03] rounded-lg border border-[#111111]/10 mb-4">
